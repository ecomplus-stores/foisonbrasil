...
module.exports = () => ({
  resolve: {
    alias: {
      ...
      './js/KitProductVariations.js': path.resolve(__dirname, 'template/js/custom-js/html/KitProductVariations.js'),   
    ...
    //    './html/APrices.html': path.resolve(__dirname, 'template/js/custom-js/html/APrices.html'),   
      ...
      './js/TheCart.js': path.resolve(__dirname, 'template/js/custom-js/html/TheCart.js'),   
      ...
      './js/EcSummary.js': path.resolve(__dirname, 'template/js/custom-js/html/EcSummary.js'),   
